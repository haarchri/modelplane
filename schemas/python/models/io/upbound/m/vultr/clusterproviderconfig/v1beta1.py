...
#   filename:  workdir/vultr_m_upbound_io_v1beta1_clusterproviderconfig.yaml
...
class Spec(BaseModel):
    ...
    """
    rateLimit: conint(ge=1) | None = None
    """
    ...
    """
    retryLimit: conint(ge=0) | None = None
    """
...
class ClusterProviderConfig(BaseModel):
    apiVersion: Literal['vultr.m.upbound.io/v1beta1'] | None = (
        'vultr.m.upbound.io/v1beta1'
    )
    """
