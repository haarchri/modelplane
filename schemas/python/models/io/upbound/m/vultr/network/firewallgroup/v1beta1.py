...
#   filename:  workdir/network_vultr_m_upbound_io_v1beta1_firewallgroup.yaml
...
class FirewallGroup(BaseModel):
    ...
    """
    kind: Literal['FirewallGroup'] | None = 'FirewallGroup'
    """
...
class FirewallGroupList(BaseModel):
    ...
    """
    List of firewallgroups. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
    """
    kind: str | None = None
    """
    Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
