...
#   filename:  workdir/database_vultr_m_upbound_io_v1beta1_quota.yaml
...
class ForProvider(BaseModel):
    ...
    """
    consumerByteRate: int | None = None
    """
    ...
    """
    producerByteRate: int | None = None
    """
    The producer byte rate for the new managed database quota.
    """
    requestPercentage: int | None = None
    """
...
class QuotaList(BaseModel):
    ...
    items: list[Quota]
    """
    List of quotas. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
    """
    kind: str | None = None
    """
    Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
