...
#   filename:  workdir/database_vultr_m_upbound_io_v1beta1_database.yaml
...
class Database(BaseModel):
    apiVersion: Literal['database.vultr.m.upbound.io/v1beta1'] | None = (
        'database.vultr.m.upbound.io/v1beta1'
    )
    """
